Shader "Transparent/Cutout/Diffuse Shake"
{
	...
	Properties
	{
		...
		_Cutoff("Alpha cutoff", Range(0,1)) = 0.014
		_ShakeDisplacement("Displacement", Range(0, 1.0)) = 0.314
		_ShakeTime("Shake Time", Range(0, 1.0)) = 0.154
		_ShakeWindspeed("Shake Windspeed", Range(0, 1.0)) = 0.605
		_ShakeBending("Shake Bending", Range(0, 1.0)) = 0.323
	}
